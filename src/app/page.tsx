...
ious symphony of SOLUTIONS! Solutions wrought through my cumbersome commitment to clothing, the brave baby steps I took
      ...
      <section id="offerings" className="relative text-[hsl(var(--foreground))]">
        <div className="mx-auto max-w-5xl px-6 py-20 md:py-28">
          <div className="mx-auto w-fit rounded-3xl border border-black/10 bg-pink-200/95 px-8 py-6 shadow-lg md:px-12">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            <div className="rounded-3xl border border-black/10 bg-pink-200/95 p-8 shadow-sm">
      ...
      <section id="invitation" className="relative text-white">
        <div className="mx-auto max-w-4xl px-6 py-20 text-center md:py-28">
          <h2 className="text-balance text-4xl leading-tight tracking-tight text-black sm:text-5xl md:text-6xl inline-block rounded-3xl border border-black/10 bg-pink-200/95 px-8 py-6 shadow-lg">Ready to play?</h2>
          <div className="mt-8 space-y-6 text-base leading-relaxed text-white/85 sm:text-lg md:text-xl">
            <div className="inline-block rounded-3xl border border-black/10 bg-pink-200/95 px-8 py-4 shadow-lg">
            ...
            <div className="inline-block rounded-3xl border border-black/10 bg-pink-200/95 px-6 py-3 shadow-lg">
